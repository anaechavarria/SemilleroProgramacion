...
\section{Resultados}
	...
	\begin{frame}
		\frametitle{Problemas Resueltos}
		\begin{block}{}
			Se resolvieron un total de 49 problemas de programación de los temas vistos en el Semillero.
			\begin{itemize}
				\item 2 como parte del trabajo del Semillero
				\item 34 problemas propuestos en competencias
				\item 13 problemas de la IV Maratón de Programación UTP
			\end{itemize}
		\end{block}
	\end{frame}
